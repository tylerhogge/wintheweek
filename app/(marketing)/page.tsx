          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[clamp(15px,1.8vw,17px)] text-[#d4d4d8] max-w-[440px] mb-10 leading-relaxed">
                Send your team an automated email (or Slack!). Collect replies. Get an AI-synthesized CEO briefing and performance reviews that write themselves. No meetings. No logins. No&nbsp;brainer.
              </p>

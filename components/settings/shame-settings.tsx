  ...
  return (
    <div className="space-y-4">
      ...
      {slackEnabled && slackConnected && (
        <div className="pl-0 space-y-2 border-l-2 border-accent/20 pl-4">
          <div>
      ...
      {/* Email report */}
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 pt-1 border-t border-white/[0.05]">
        <div className="flex-1">
